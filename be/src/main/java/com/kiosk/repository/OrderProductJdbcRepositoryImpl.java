...
//
//@Repository
//public class OrderProductJdbcRepositoryImpl implements OrderProductRepository {
//
//    private final NamedParameterJdbcTemplate template;
//
//    public OrderProductJdbcRepositoryImpl(NamedParameterJdbcTemplate template) {
...
//                        + "values (:name, :amount, :size, :temperature, :orderId, :productId)";
//
//        SqlParameterSource[] params = orderProducts.stream()
